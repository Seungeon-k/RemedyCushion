...
- 압력센서의 측정값을 처리하고 자세 상태를 판별하는 과정을 통해 센서 데이터 활용 방법을 익혔습니다.
- 센서 데이터가 Arduino와 블루투스를 거쳐 Android 앱에 전달되는 전체 데이터 흐름을 구현하며 하드웨어와 소프트웨어의 연동 과정을 경험했습니다.
- 센서의 측정값과 앱의 자세 판정 결과가 올바르게 연결되도록 조정하는 과정에서 통신 데이터 형식과 판정 로직의 중요성을 배웠습니다.
- 실제 구현 내용과 README 등의 문서를 일치시키는 기록 관리의 중요성을 알게 되었습니다.
